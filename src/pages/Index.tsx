...
const desktopBrochureImages = [
  {
    src: "/lovable-uploads/flyer_page_0.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 1"
  },
  {
    src: "/lovable-uploads/flyer_page_1.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 2"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-1a4x_2.png",
    alt: "Flyer Trường Điện - Điện tử - Mặt 1"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-2a4x_1.png",
    alt: "Flyer Trường Điện - Điện tử - Mặt 2"
  }
];

const mobileBrochureImages = [
  {
    src: "/lovable-uploads/flyer_page_0_right.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 1"
  },
  {
    src: "/lovable-uploads/flyer_page_0_left.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 2"
  },
  {
    src: "/lovable-uploads/flyer_page_1_left.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 3"
  },
  {
    src: "/lovable-uploads/flyer_page_1_right.png",
    alt: "Flyer ĐH Bách khoa Hà Nội 2026 - Trang 4"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-1a4x_2_right.png",
    alt: "Flyer Trường Điện - Điện tử - Trang 5"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-1a4x_2_left.png",
    alt: "Flyer Trường Điện - Điện tử - Trang 6"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-2a4x_1_right.png",
    alt: "Flyer Trường Điện - Điện tử - Trang 7"
  },
  {
    src: "/lovable-uploads/flyer-seee-side-2a4x_1_left.png",
    alt: "Flyer Trường Điện - Điện tử - Trang 8"
  }
];
...
const Index = () => {
  ...
  const brochureImages = isMobile ? mobileBrochureImages : desktopBrochureImages;

  useEffect(() => {
    setCurrentSlide((prev) => {
      const maxLength = brochureImages.length;
      return prev >= maxLength ? 0 : prev;
    });
  }, [isMobile, brochureImages.length]);
      ...
      <main className="container mx-auto px-4 py-8 max-w-[1380px]">
        ...
        <div className="mt-8">
          <div className="bg-white border border-slate-200 rounded-md shadow-sm overflow-hidden">
            ...
            <div className="relative group w-full max-w-xl md:max-w-5xl mx-auto bg-white p-0">
